...
export function ImportQueue({ files, onClear }: ImportQueueProps) {
...
function FileCard({ file, index }: { file: FileImportState; index: number }) {
  return (
    <div
      className="px-6 py-3.5 flex items-center gap-3 animate-fade-slide-up"
